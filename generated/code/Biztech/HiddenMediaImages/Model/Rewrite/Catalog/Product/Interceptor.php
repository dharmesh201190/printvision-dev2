...
class Interceptor extends \Biztech\HiddenMediaImages\Model\Rewrite\Catalog\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllMediaGalleryImages');
        if (!$pluginInfo) {
            return parent::getAllMediaGalleryImages();
        } else {
            return $this->___callPlugins('getAllMediaGalleryImages', func_get_args(), $pluginInfo);
        }
    }
