...
return [
    'modules' => [
        ...
        'Biztech_Productdesigner' => 1,
        'Biztech_BackgroundPatterns' => 1,
        'Biztech_CustomColorPicker' => 1,
        'Biztech_DPI' => 1,
        'Biztech_DesignTemplates' => 1,
        'Biztech_Designerapp' => 1,
        'Biztech_EditablePdf' => 1,
        'Biztech_HiddenMediaImages' => 1,
        'Biztech_ImageSlider' => 1,
        'Biztech_Magemobcart' => 1,
        'Biztech_MultipleDesignAreas' => 1,
        'Biztech_NameNumber' => 1,
        'Biztech_ObjectAlignmentPosition' => 1,
        'Biztech_PriceInfo' => 1,
        'Biztech_AdvancedCliparts' => 1,
        'Biztech_SocialMediaSharing' => 1,
        'Biztech_TabsManagement' => 1,
        'Biztech_ThemeColors' => 1,
        'Biztech_Watermark' => 1,
        'Codazon_AjaxCartPro' => 0,
        ...
        'Magepow_Core' => 1,
        'Magetop_Smtp' => 1,
        'Biztech_AdvancedImageEffects' => 1,
        'Printvision_ProductInquiry' => 1,
        'SamSolutions_AddOnsFields' => 1,
        'SamSolutions_Artwork' => 1,
        'Sparsh_Faq' => 1,
